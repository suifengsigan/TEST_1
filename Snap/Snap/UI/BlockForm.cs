namespace Snap.UI
{
    ...
    public class BlockForm
    {
        ...
        public BlockForm()
        {
            ...
            this.SnapBlockDialog.AddKeyboardFocusNotifyHandler(new NXOpen.BlockStyler.BlockDialog.KeyboardFocusNotify(this.keyboardFocusNotify_cb));
            this.SnapBlockDialog.AddEnableOKButtonHandler(new NXOpen.BlockStyler.BlockDialog.EnableOKButton(this.enableOKButton_cb));
