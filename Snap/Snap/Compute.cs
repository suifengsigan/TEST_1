namespace Snap
{
    ...
    public static class Compute
    {
        ...
        {
            Snap.NX.Body[] bodyArray = Enumerable.Where<Snap.NX.Body>(bodies,u=>u.IsSolidBody).ToArray<Snap.NX.Body>();
            Snap.NX.Body[] bodyArray2 = Enumerable.Where<Snap.NX.Body>(bodies, u => u.IsSheetBody).ToArray<Snap.NX.Body>();
