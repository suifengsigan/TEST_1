namespace NXOpen
{
    ...
    public class AngularSpring : SpringJoint
    {
        private const int ANGULAR_SPRING_ACTIVE = 11;
        private const int ANGULAR_SPRING_ATTACH = 0;
        private const int ANGULAR_SPRING_ATTACH_DIRECTION_X = 2;
        private const int ANGULAR_SPRING_ATTACH_DIRECTION_Y = 3;
        private const int ANGULAR_SPRING_ATTACH_DIRECTION_Z = 4;
        private const int ANGULAR_SPRING_BASE = 1;
        private const int ANGULAR_SPRING_BASE_DIRECTION_X = 5;
        private const int ANGULAR_SPRING_BASE_DIRECTION_Y = 6;
        private const int ANGULAR_SPRING_BASE_DIRECTION_Z = 7;
        private const int ANGULAR_SPRING_CONSTANT = 8;
        private const int ANGULAR_SPRING_DAMPING = 9;
        private const int ANGULAR_SPRING_RELAXED_POSITION = 10;
        private static Factory m_factory = new Factory();

        protected AngularSpring(IntPtr pItem) : base(pItem)
        {
        }

        internal static void Init()
        {
            RuntimeObject.s_arrClassGen[0x65f4] = m_factory;
        }
        ...
        internal class Factory : IItemFactory
        {
            ...
            {
                return new AngularSpring(pItem);
            }
        }
    }
}
