namespace NXOpen
{
    ...
    {
        private const int CYLINDER_JOINT_ACTIVE = 10;
        private const int CYLINDER_JOINT_ANCHOR_X = 2;
        private const int CYLINDER_JOINT_ANCHOR_Y = 3;
        private const int CYLINDER_JOINT_ANCHOR_Z = 4;
        private const int CYLINDER_JOINT_ANGLE = 8;
        private const int CYLINDER_JOINT_ATTACH = 0;
        private const int CYLINDER_JOINT_AXIS_X = 5;
        private const int CYLINDER_JOINT_AXIS_Y = 6;
        private const int CYLINDER_JOINT_AXIS_Z = 7;
        private const int CYLINDER_JOINT_BASE = 1;
        private const int CYLINDER_JOINT_POSITION = 9;
        private static Factory m_factory = new Factory();

        protected CylindricalJoint(IntPtr pItem) : base(pItem)
        {
        }
        ...
        {
            RuntimeObject.s_arrClassGen[0x5334] = m_factory;
        }
        ...
        internal class Factory : IItemFactory
        {
            ...
            {
                return new CylindricalJoint(pItem);
            }
        }
    }
}
