namespace NXOpen
{
    ...
    public class AngularLimit : LimitJoint
    {
        private const int ANGULAR_LIMIT_ACTIVE = 10;
        private const int ANGULAR_LIMIT_ATTACH = 0;
        private const int ANGULAR_LIMIT_ATTACH_DIRECTION_X = 2;
        private const int ANGULAR_LIMIT_ATTACH_DIRECTION_Y = 3;
        private const int ANGULAR_LIMIT_ATTACH_DIRECTION_Z = 4;
        private const int ANGULAR_LIMIT_BASE = 1;
        private const int ANGULAR_LIMIT_BASE_DIRECTION_X = 5;
        private const int ANGULAR_LIMIT_BASE_DIRECTION_Y = 6;
        private const int ANGULAR_LIMIT_BASE_DIRECTION_Z = 7;
        private const int ANGULAR_LIMIT_MAXIMUM_POSITION = 9;
        private const int ANGULAR_LIMIT_MINIMUM_POSITION = 8;
        private static Factory m_factory = new Factory();

        protected AngularLimit(IntPtr pItem) : base(pItem)
        {
        }

        internal static void Init()
        {
            RuntimeObject.s_arrClassGen[0x69dc] = m_factory;
        }
