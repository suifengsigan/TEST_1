...
public class EleAutoCamUI
{
    ...
    private NXOpen.BlockStyler.FaceCollector face_select02;// Block type: Face Collector
    ...
    private NXOpen.BlockStyler.Enumeration enum03;// Block type: Enumeration
    private NXOpen.BlockStyler.DoubleBlock double03;// Block type: Double
    ...
    private NXOpen.BlockStyler.Button button07;// Block type: Button
    private NXOpen.BlockStyler.Button button08;// Block type: Button
    //------------------------------------------------------------------------------
