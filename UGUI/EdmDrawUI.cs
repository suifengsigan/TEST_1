...
public class EdmDrawUI
{
    ...
    private NXOpen.BlockStyler.IntegerBlock txtDrfLayer;// Block type: Integer
    private NXOpen.BlockStyler.Enumeration selectTemplate0;// Block type: Enumeration
    //------------------------------------------------------------------------------
    ...
    public void initialize_cb()
    {
        try
        {
            ...
            txtDrfLayer = (NXOpen.BlockStyler.IntegerBlock)theDialog.TopBlock.FindBlock("txtDrfLayer");
            selectTemplate0 = (NXOpen.BlockStyler.Enumeration)theDialog.TopBlock.FindBlock("selectTemplate0");
        }
        catch (Exception ex)
        {
            //---- Enter your exception handling code here -----
