...
//        Created by: PENGHUI
//              Version: NX 9
//              Date: 09-18-2018  (Format: mm-dd-yyyy)
...
public class SelectSteelUI
{
    ...
    private NXOpen.BlockStyler.Toggle toggleIsDistinguishSideElec;// Block type: Toggle
    ...
    private NXOpen.BlockStyler.Group groupElecLayer;// Block type: Group
    private NXOpen.BlockStyler.IntegerBlock integerElecStartLayer;// Block type: Integer
    private NXOpen.BlockStyler.IntegerBlock integerElecEndLayer;// Block type: Integer
    ...
    public int update_cb( NXOpen.BlockStyler.UIBlock block)
    {
        try
        {
            ...
            else if(block == toggleIsDistinguishSideElec)
            {
            //---------Enter your code here-----------
            }
            ...
            else if(block == integerElecStartLayer)
            {
            //---------Enter your code here-----------
            }
            else if(block == integerElecEndLayer)
            {
            //---------Enter your code here-----------
            }
