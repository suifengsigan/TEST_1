...
//        Created by: PENGHUI
//              Version: NX 9
//              Date: 12-03-2018  (Format: mm-dd-yyyy)
...
public class SetPropertyUI
{
    ...
    private NXOpen.BlockStyler.Group groupSElec;// Block type: Group
    private NXOpen.BlockStyler.SelectObject selectTopFace;// Block type: Selection
    private NXOpen.BlockStyler.SelectObject selectBaseFace;// Block type: Selection
    private NXOpen.BlockStyler.SelectObject selectBaseFacePoint;// Block type: Selection
    private NXOpen.BlockStyler.SpecifyPoint selectBaseFacePointEx;// Block type: Specify Point
    ...
    private NXOpen.BlockStyler.Enumeration cboxMMATNAME;// Block type: Enumeration
    private NXOpen.BlockStyler.Enumeration cboxRMATNAME;// Block type: Enumeration
    ...
    private NXOpen.BlockStyler.StringBlock stringExp;// Block type: String
    private NXOpen.BlockStyler.StringBlock stringExp1;// Block type: String
    ...
    private NXOpen.BlockStyler.Enumeration cbbCAPSET;// Block type: Enumeration
    private NXOpen.BlockStyler.Enumeration cbbRockShape;// Block type: Enumeration
    private NXOpen.BlockStyler.Enumeration cbbShape;// Block type: Enumeration
    //------------------------------------------------------------------------------
    ...
    public int update_cb( NXOpen.BlockStyler.UIBlock block)
    {
        try
        {
            ...
            else if(block == selectTopFace)
            {
            //---------Enter your code here-----------
            }
            else if(block == selectBaseFace)
            {
            //---------Enter your code here-----------
            }
            else if(block == selectBaseFacePoint)
            {
            //---------Enter your code here-----------
            }
            else if(block == selectBaseFacePointEx)
            {
            //---------Enter your code here-----------
            }
            ...
            else if(block == cboxMMATNAME)
            {
            //---------Enter your code here-----------
            }
            else if(block == cboxRMATNAME)
            {
            //---------Enter your code here-----------
            }
            ...
            else if(block == stringExp)
            {
            //---------Enter your code here-----------
            }
            else if(block == stringExp1)
            {
            //---------Enter your code here-----------
            }
            ...
            else if(block == cbbCAPSET)
            {
            //---------Enter your code here-----------
            }
            else if(block == cbbRockShape)
            {
            //---------Enter your code here-----------
            }
            else if(block == cbbShape)
            {
            //---------Enter your code here-----------
            }
        }
