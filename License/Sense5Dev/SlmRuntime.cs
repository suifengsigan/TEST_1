...
namespace SLM
{
    ...
    {
        public const string DllName = "EliteNet\\slm_runtime_easyX86.dll";
        /// <summary>
        /// 
        /// </summary>
        /// <returns></returns>
        [DllImport(DllName, EntryPoint = "#1", CallingConvention = CallingConvention.StdCall)]
        ...
        /// </summary>
        /// <returns></returns>
        [DllImport(DllName, EntryPoint = "#2", CallingConvention = CallingConvention.StdCall)]
        ...
        /// <returns></returns>
        [DllImport(DllName, EntryPoint = "#4", CallingConvention = CallingConvention.StdCall)]
        ...
        /// </summary>
        /// <returns></returns>
        [DllImport(DllName, EntryPoint = "#5", CallingConvention = CallingConvention.StdCall)]
        ...
        /// </summary>
        /// <returns></returns>
        [DllImport(DllName, EntryPoint = "#6", CallingConvention = CallingConvention.StdCall)]
        ...
        /// <returns></returns>
        [DllImport(DllName, EntryPoint = "#8", CallingConvention = CallingConvention.StdCall)]
        ...
        [DllImport(DllName, EntryPoint = "#27", CallingConvention = CallingConvention.StdCall)]
        ...
        [DllImport(DllName, EntryPoint = "#25", CallingConvention = CallingConvention.StdCall)]
        ...
        [DllImport(DllName, EntryPoint = "#26", CallingConvention = CallingConvention.StdCall)]
        ...
        /// <returns>IntPtr 返回错误信息，使用需要调用SlmFreeEasy释放</returns>
        [DllImport(DllName, EntryPoint = "#34", CallingConvention = CallingConvention.StdCall)]
        ...
        [DllImport(DllName, EntryPoint = "#38", CallingConvention = CallingConvention.StdCall)]
        ...
        [DllImport(DllName, EntryPoint = "#31", CallingConvention = CallingConvention.StdCall)]
        ...
        /// <returns></returns>
        [DllImport(DllName, EntryPoint = "#33", CallingConvention = CallingConvention.StdCall)]
        ...
        /// <returns></returns>
        [DllImport(DllName, EntryPoint = "#39", CallingConvention = CallingConvention.StdCall)]
        ...
        [DllImport(DllName, EntryPoint = "#40", CallingConvention = CallingConvention.StdCall)]
        ...
        [DllImport(DllName, EntryPoint = "#41", CallingConvention = CallingConvention.StdCall)]
        ...
        [DllImport(DllName, EntryPoint = "#42", CallingConvention = CallingConvention.StdCall)]
        ...
        [DllImport(DllName, EntryPoint = "#43", CallingConvention = CallingConvention.StdCall)]
