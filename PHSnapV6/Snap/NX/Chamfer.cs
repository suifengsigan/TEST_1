namespace Snap.NX
{
    ...
    {
        internal Chamfer(NXOpen.Features.Chamfer chamfer) : base(chamfer)
        {
        ...
        public static implicit operator Snap.NX.Chamfer(NXOpen.Features.Chamfer chamfer)
        {
            return new Snap.NX.Chamfer(chamfer);
        }

        public static implicit operator NXOpen.Features.Chamfer(Snap.NX.Chamfer chamfer)
        {
            return (NXOpen.Features.Chamfer) chamfer.NXOpenTaggedObject;
        }
        ...
        public static Snap.NX.Chamfer Wrap(Tag nxopenChamferTag)
        {
            ...
            NXOpen.Features.Chamfer objectFromTag = Snap.NX.NXObject.GetObjectFromTag(nxopenChamferTag) as NXOpen.Features.Chamfer;
        ...
        public NXOpen.Features.Chamfer NXOpenChamfer
        {
            get
            {
                return (NXOpen.Features.Chamfer) base.NXOpenTaggedObject;
            }
            private set
            {
