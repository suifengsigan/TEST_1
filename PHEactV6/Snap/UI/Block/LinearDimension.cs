namespace Snap.UI.Block
{
    ...
    public class LinearDimension : General
    {
        ...
        internal LinearDimension(UIBlock uiBlock)
        {
            base.NXOpenBlock = uiBlock;
        }

        public static Snap.UI.Block.LinearDimension GetBlock(BlockDialog dialog, string name)
        {
            return new Snap.UI.Block.LinearDimension(dialog.TopBlock.FindBlock(name));
        }

        private void Initialize()
        {
            base.Type = "Linear Dim";
            base.Show = true;
