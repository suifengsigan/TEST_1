namespace Snap.UI.Block
{
    ...
    public class SuperSection : General
    {
        public SuperSection()
        {
            this.Initialize();
        ...
        internal SuperSection(UIBlock uiBlock)
        {
            base.NXOpenBlock = uiBlock;
        }

        public static Snap.UI.Block.SuperSection GetBlock(BlockDialog dialog, string name)
        {
            return new Snap.UI.Block.SuperSection(dialog.TopBlock.FindBlock(name));
        }

        private void Initialize()
        {
            base.Type = "Super Section";
            base.Show = true;
            ...
            this.Cue = "Select planar face to sketch or select section geometry";
        ...
        public bool SketchOnPath
        {
            get
            {
                return (bool) PropertyAccess.GetPropertyValue(this, Snap.UI.Block.PropertyType.Logical, "SketchOnPath");
            }
            set
            {
                PropertyAccess.SetPropertyValue(this, Snap.UI.Block.PropertyType.Logical, "SketchOnPath", value);
            }
        }
