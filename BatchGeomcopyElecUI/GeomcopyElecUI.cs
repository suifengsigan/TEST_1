...
//
//       Filename:  F:\PHEactProject\Source\Project\UGUI\BatchGeomcopyElecUI.cs
//
...
//------------------------------------------------------------------------------
public partial class BatchGeomcopyElecUI
{
    //class members
    ...
    private Snap.UI.Block.Toggle togglePreview;// Block type: Toggle
    ...
    //------------------------------------------------------------------------------
    public BatchGeomcopyElecUI()
    {
        try
        {
            theSession = Session.GetSession();
            theUI = UI.GetUI();
            theDlxFileName = "BatchGeomcopyElecUI.dlx";
    ...
    public void initialize_cb()
    {
        try
        {
            ...
            togglePreview = Snap.UI.Block.Toggle.GetBlock(theDialog,"togglePreview");
