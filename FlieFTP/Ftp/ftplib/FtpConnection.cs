...
namespace FtpLib
{
    ...
    {
        int FTP_TRANSFER_TYPE = WININET.FTP_TRANSFER_TYPE_BINARY;
        /// <summary>
        ...
        public FtpConnection(string host, int port, string username, string password)
        {
            ...
            {
                FTP_TRANSFER_TYPE = WININET.FTP_TRANSFER_TYPE_ASCII;
            }
        ...
        public long GetFileSize(string file)
        {
            IntPtr hFile = new IntPtr(
                WININET.FtpOpenFile(_hConnect, file, WINAPI.GENERIC_READ, FTP_TRANSFER_TYPE, IntPtr.Zero)
            );
