...
namespace DataAccess
{
    ...
    public abstract class Eman
    {
            ...
            ) 
        {
            ...
            sql.AppendLine(" FROM    dbo.MaterialClassify where dbo.MaterialClassify.mark <> 1 and (dbo.MaterialClassify.materialName ='电极设计' or dbo.MaterialClassify.materialName ='电极')");
            //获取所有的材质类型
            //TODO 匹配标准料
