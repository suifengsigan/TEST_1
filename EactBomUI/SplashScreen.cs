    ...
    public class Splasher
    {
        ...
        public static string Status
        {
            set
            {
                ...
                TryInvoke(m_SplashForm, () => { m_SplashInterface.SetStatusInfo(value); });
            }
        ...
        public static void Close()
        {
            ...
            TryInvoke(m_SplashForm, m_SplashForm.Close);
        ...
        private static void TryInvoke(System.Windows.Forms.Control c, Action action) 
        {
            try
            {
                if (c.InvokeRequired)
