...
//
//       Filename:  H:\PHEact\Application\ExtractBodyUI.cs
//
//        This file was generated by the NX Block UI Styler
//        Created by: PENGHUI
//              Version: NX 9
//              Date: 09-26-2017  (Format: mm-dd-yyyy)
...
//------------------------------------------------------------------------------
public partial class ExtractBodyUI
{
    //class members
    ...
    private NXOpen.BlockStyler.BodyCollector bodySelect0;// Block type: Body Collector
    private NXOpen.BlockStyler.FolderSelection nativeFolderBrowser0;// Block type: NativeFolderBrowser
    ...
    //------------------------------------------------------------------------------
    public ExtractBodyUI()
    {
        try
        {
            theSession = Session.GetSession();
            theUI = UI.GetUI();
            theDlxFileName = "ExtractBodyUI.dlx";
    ...
    {
        ExtractBodyUI theExtractBodyUI = null;
        try
        {
            theExtractBodyUI = new ExtractBodyUI();
            // The following method shows the dialog immediately
            theExtractBodyUI.Show();
        }
        catch (Exception ex)
        {
            //---- Enter your exception handling code here -----
        ...
        {
            if(theExtractBodyUI != null)
                theExtractBodyUI.Dispose();
                theExtractBodyUI = null;
        }
    }
    //------------------------------------------------------------------------------
